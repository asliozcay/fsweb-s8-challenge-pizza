...
function siparisVer() {
  cy.visit('http://localhost:5175/order-pizza');
  cy.contains("M").click();
...
describe('Success sayfası testleri', () => {
  ...
  it('Metin kontrolü', () => {
    cy.visit('http://localhost:5175/success');
  ...
  it('Form gönderip sayfaya erişince yazı kontrolü', () => {
    ...
    cy.contains('Ek Malzemeler:Pepperoni, Sosis, Kanada Jambonu, Tavuk Izgara, Soğan, Domates, Mısır');
